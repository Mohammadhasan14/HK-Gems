...
export const metadata: Metadata = {
  title: "HK GEMS — The Life of a Stone",
  description:
    "Follow natural turquoise from the earth through careful craftsmanship to a timeless silver ring. Real stones. Real stories.",
  openGraph: {
    title: "HK GEMS — The Life of a Stone",
    description:
      "Natural turquoise, shaped by hand and set in silver. Discover the life of a stone.",
